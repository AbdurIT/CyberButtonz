...
## 📁 Source Code Map (Project Structure)
...
2. Open any HTML file inside **/buttons**  
...
All buttons are fully compatible with **JavaScript events**, so you can attach your own  
`onClick` functions for actions like opening modals, navigating pages, triggering sounds, etc.
